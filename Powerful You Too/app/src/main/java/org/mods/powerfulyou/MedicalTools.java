...
public class MedicalTools extends Activity{
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        TextView stethoscope = (TextView) findViewById(R.id.stethoscopetext);
        TextView forceps = (TextView) findViewById(R.id.stethoscopetext);
        TextView scalpel = (TextView) findViewById(R.id.stethoscopetext);
